...
export type CardStackProps<T extends CardStackItem> = {
  ...
  onImageClick?: (index: number, item: T) => void;
                ...
                >
                  ...
                  >
                    {renderCard ? (
                      ...
                      <DefaultFanCard item={item} active={isActive} onImageClick={() => onImageClick?.(i, item)} />
                    )}
                  </div>
                </motion.div>
              );
...
function DefaultFanCard({ item, active, onImageClick }: { item: CardStackItem; active: boolean; onImageClick?: () => void }) {
  return (
